...
public class DrawerLeftMenu1 extends FrameLayout implements OnClickListener {
	...
	public DrawerLeftMenu1(Context context) {
		super(context);
		mContext = context;
		initView();
		setValue();
	...
	public DrawerLeftMenu1(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		initView();
		setValue();
